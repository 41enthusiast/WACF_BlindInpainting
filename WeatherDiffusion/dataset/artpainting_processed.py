...
class ArtPainting_processedDataset(torch.utils.data.Dataset):
    def __init__(self, dir, patch_size, n, transforms, filelist=None, parse_patches=True):
        ...
        if filelist is None:
            ...
            # print(snow100k_dir)
            snow_inputs = os.path.join(snow100k_dir, 'masked')
            ...
            gt_names += [os.path.join(os.path.join(snow100k_dir, 'image'), i) for i in images]
            ...
            with open(train_list) as f:
                ...
                gt_names = [i.strip().replace('masked', 'image') for i in input_names]
