...
import kornia
from utils import rgb_to_y, psnr, ssim, VGGPerceptualLoss, parse_args
...
if __name__ == '__main__':
    ...
    model = Inpainting(args.num_blocks, args.num_heads, args.channels, args.num_refinement, args.expansion_factor).cuda()
